...
export interface SchoolClassDetails {
  ...
  submissions: { submissionId: string; activityId: string; studentName: string; score: number; submittedAt: number; gradingStatus?: "awaiting_marking" | "finalized"; provisionalScore?: number }[];
