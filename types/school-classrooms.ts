...
export interface SchoolClassDetails {
  ...
  results: { resultId: string; activityId: string; studentMembershipId: string; studentName: string; score: number; submittedAt: number; teacherSubmittedAt: number; attemptNumber: number; type: string; title: string; subject: string }[];
