...
`OPENAI_IMAGE_MODEL` enables optional illustrations during Deep lesson-note refinement. Quiks first decides whether a real visual is instructionally necessary and generates at most two images per refinement request. Minimal and Rich refinement never call the image model. Removing or leaving this variable empty disables generated images without disabling lesson-note refinement.
